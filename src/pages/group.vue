  ...
  data() {
    return {
      ...
      testData: { // TODO: load data
        groups: [
          { id: '1', name: 'CS', company: '会社１', color: '#fffd46', email: { on: true, address: 'hoge.email.com' }, chatwork: { on: true, token: 'API_TOKEN_HOGE', roomId: '12345' }, slack: { on: true, webhook: 'https://hooks.slack.com/services/XXXXX/XXXXX', channel: 'hoge' }, userNum: 0, updateInfo: '', registerInfo: '' },
          { id: '2', name: '開発', company: '会社１', color: '#ff00ff', email: { on: false, address: '' }, chatwork: { on: false, token: '', roomId: '' }, slack: { on: false, webhook: '', channel: '' }, userNum: 10, updateInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)', registerInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)' },
          ...
          { id: '5', name: 'マングループ', company: '会社１', color: '#f9ffaf', email: { on: false, address: '' }, chatwork: { on: false, token: '', roomId: '' }, slack: { on: false, webhook: '', channel: '' }, userNum: 10, updateInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)', registerInfo: ''  },
          ...
          { id: '7', name: 'アメリカ', company: '会社１', color: '#f9ccaf', email: { on: false, address: '' }, chatwork: { on: false, token: '', roomId: '' }, slack: { on: false, webhook: '', channel: '' }, userNum: 10, updateInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)', registerInfo: '' },
          ...
          { id: '10', name: '委員会', company: '会社１', color: '#ffa6ee', email: { on: false, address: '' }, chatwork: { on: false, token: '', roomId: '' }, slack: { on: false, webhook: '', channel: '' }, userNum: 10, updateInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)', registerInfo: '' },
          { id: '11', name: 'ゲームス01', company: '会社3', color: '#f9eeaf', email: { on: false, address: '' }, chatwork: { on: false, token: '', roomId: '' }, slack: { on: false, webhook: '', channel: '' }, userNum: 10, updateInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)', registerInfo: '' },
          { id: '12', name: 'チームG', company: '会社3', color: '#fcc2af', email: { on: false, address: '' }, chatwork: { on: false, token: '', roomId: '' }, slack: { on: false, webhook: '', channel: '' }, userNum: 10, updateInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)', registerInfo: '' },
          { id: '13', name: '管理ユーザ', company: '会社１', color: '#4df2af', email: { on: false, address: '' }, chatwork: { on: false, token: '', roomId: '' }, slack: { on: false, webhook: '', channel: '' }, userNum: 10, updateInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)', registerInfo: '' },
          ...
          { id: '15', name: 'グループ01', company: '会社１', color: '#f9ddaf', email: { on: false, address: '' }, chatwork: { on: false, token: '', roomId: '' }, slack: { on: false, webhook: '', channel: '' }, userNum: 10, updateInfo: 'チケット 三郎汰 (2013-04-08 15:28:32)', registerInfo: '' }
        ]
      }
    };
  }
